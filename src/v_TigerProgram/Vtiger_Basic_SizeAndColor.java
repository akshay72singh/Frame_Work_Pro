...
//    	driver.findElement(By.xpath("//input[@id='savebtn']")).click();
    	...
    	List<WebElement> LinkOfTop = driver.findElements(By.xpath("//table[@class='small showPanelBg']//b[contains(text(),'s')]"));
    	...
    	List<WebElement>allTagName = driver.findElements(By.xpath("//table[@class='small showPanelBg']//b[contains(text(),'s')]"));
